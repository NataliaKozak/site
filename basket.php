...
<body>
	...
	<div class = "subMenu">
		<div class = "basket" id = "#basket" data-info = "basket">Корзина</div>
		<div class = "basket" id = "#orders" data-info = "orders">Посмотреть все заказы</div>
	</div>
			...
			<div class="modal-body">
				...
				<form  class = "formLogIn"  id = "formLogIn" method = "post" action = "logIn.php">
					...
					<p class="typeOfText"> Адрес доставки: 
					    <div>
					      	<input type = "text" id = "adress" class = "textBox" autocomplete="off" >
					    </div>
					</p>
					...
					<p class="typeOfText"> Кто будет получать заказ? </p>
					    <div class="dropdownForh">
					      	<div class="select">
					      		<span>Выбрать</span>
					      		<i class="fa fa-chevron-left"></i>
					      	</div>
					      	...
					      	<ul class="dropdown-menu">
					      		<li data-content = "Я лично"> Я лично </li>
					      		<li  data-content = "Доставка другому человеку"> Доставка другому человеку </li>
					      	</ul>
					    </div>
					</p>
