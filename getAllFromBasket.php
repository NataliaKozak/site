...
while($row = mysqli_fetch_assoc($query)){
	...
	echo '
		<div class = "element">
			...
			<div class = "elementImg"><img src = "'.$row["photo"].'"></div>
			<div class = "namePrice">Цена: <span class = "infoPrice" id = "price" data-price = '.$row["price"].' data-numbOf = '.$row["numberOf"].'>'.$row["price"] * $row["numberOf"].'</span></div>
